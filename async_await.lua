...
-- Да, async создает машину состояний для того, чтобы асинхронный код можно писать последовательно. 
-- await позволяет последовательно дожидаться выполнения асинхронной функции в пределах async блока
